...
node1.ajacenciesList.append(edge1);
node1.ajacenciesList.append(edge2);
node2.ajacenciesList.append(edge3);
node3.ajacenciesList.append(edge4);
node3.ajacenciesList.append(edge2);
...
algorithm = Algorithm();
algorithm.caclculateShortestPath(vertexList, edgeList, node1);
